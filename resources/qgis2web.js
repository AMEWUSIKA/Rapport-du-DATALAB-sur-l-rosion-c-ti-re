...
map.getView().fit([302949.470821, 654385.399512, 354145.815872, 688967.671245], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Dynamique de l\'érosion côtière au TOGO_1984 -2025</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (536 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Ce webmapping est réalisé dans la cadre du premier Rapport du DATALAB_TOGO sur la dynamique de l\'érosion côtière. Elle permet de visualiser l’évolution du trait côtière du Togo de 1984 à 2025, à partir d’analyses multi-temporelles d’images satellitaires tout en mettant en évidence les zones à forte risque(HOT SPOT). Les decideurs peuvent comparer le trait de côte à différentes dates, repérer les secteurs d’érosion ou d’accumulation et mieux comprendre les dynamiques littorales pour soutenir une gestion durable du littoral togolais';
            }
